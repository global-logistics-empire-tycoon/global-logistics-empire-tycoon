...
(function () {
  ...
  async function setLanguage(code) {
    ...
    // Soubor držíš jako "ua", ale HTML lang nech validní jako uk-UA
    const htmlLang = code === 'ua' ? 'uk-UA' : code;
  ...
  function renderMenu(active) {
    ...
    LANGUAGES.forEach(l => {
      ...
      btn.innerHTML =
        '<span class="flag">' + l.flag + '</span><span>' + l.label + '</span><span class="code">' + l.code.toUpperCase() + '</span>';
